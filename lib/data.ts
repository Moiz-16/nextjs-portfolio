...
export const educationData = [
  {
    ...
    achievements: [
      "Founder, Nexus.",
      "Quantitative Analyst, Bristol Trading Society.",
      "Invited undergraduate speaker, Institute of Mathematics and its Applications.",
      "Research Intern, University of Bristol Business School.",
      "SEO London Candidate and upReach Associate.",
      "Bristol PLUS Award recipient.",
    ],
    stats: [
      { label: "Result", value: "2:1" },
      { label: "Focus", value: "HPC" },
